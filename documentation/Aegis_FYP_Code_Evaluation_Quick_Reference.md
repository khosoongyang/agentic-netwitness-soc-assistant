...
|---|---|---|---|---|---|---|
| NetWitness Respond | app.py; APIRetrieval.py | nw_login / nw_fetch_incidents / fetch_* | Authenticate and retrieve incidents/alerts | host, credentials/token, pagination | incident/alert JSON | timeouts/auth errors return actionable status; bounded partial fetch |
