...
# file in soc_reporting_agent/adapters/common.py. The canonical, actively-used
# implementation is soc_reporting_agent/adapters/common.py (documented separately).
# This copy is not imported anywhere else in the repository and is retained here
